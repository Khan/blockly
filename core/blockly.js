...
Blockly.onMouseDown_ = function(e) {
  ...
  if (e.target == Blockly.svg && Blockly.isRightButton(e)) {
    ...
    // If is a touch event bind to the mouse up so workspace drag mode is turned off and double move 
    // events are not performed on a block. See comment in inject.js Blockly.init_ as to why mouseup
    // events are not bound to the document.
